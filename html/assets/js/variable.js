...
/* light overlay */
var _lightOverlayColor = 'rgba(255, 255, 255, 0.8)'; // [rgba format] - overlay color
var _lightFormOverlayColor = 'rgba(62, 68, 89, 0.8)'; // [rgba format] - form overlay color

/* dark overlay */
var _darkOverlayColor = 'rgba(0, 0, 0, 0.8)'; // [rgba format] - overlay color
...
var _countdownDate = '01/01/2018 18:00:00'; // 2015-12-24 23:59:59
var _countdownTimezone = '+3'; // timezone
...
_bgStyle = 4
  - youtube video
=================================================*/
var _ytUrl = '1nkO4N7P-Ys'; // youtube video id
var _ytQuality = 'hightres'; // hightres, hd1080, hd720, default - youtube video quality
var _ytStart = 5; // start time (seconds)
var _ytEnd = 88; // end time (seconds), 0 to ignored
