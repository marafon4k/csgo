...
$(document).ready(function() {
    ...
    if (LANG_SELECT == 'ru') {
        ...
        LNG['COINS_STEAMID'] = ' coins на Steam ID ';
        LNG['YOU_SURE'] = ' - вы уверены?';
        LNG['CHAT_CLEAR'] = 'Чат очищен!';
        LNG['YOU_SURE_BET'] = 'Вы уверены, что хотите поставить ';
        LNG['WARNING_BET'] = ' coins?<br><br><i>Вы можете выключить данное подтверждение в настройках.</i>';
        ...
        LNG['ON'] = 'за';
        LNG['COINS_PLEASE'] = 'coins. Пожалуйста, <a href=\'https://steamcommunity.com/tradeoffer/';
        ...
        LNG['FULL_LOAD'] = 'CSEURO.COM сервера в данный момент переполнены - пожалуйста, попробуйте позже.';
        ...
        LNG['FULL_LOAD'] = 'CSEURO.COM servers are currently full - please try back later.';
