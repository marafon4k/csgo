    ...
    function() {
        ...
        _animate: function(t, e, i) {
            var s, n, o, a = this,
                ...
                u = this.options.animate || {}, c = l && u.down || u,
                d = function() {
                    a._toggleComplete(i)
                };
        ...
        resize: function(e, i) {
            ...
            t(n.alsoResize).each(function() {
                var e = t(this),
                    ...
                    n = {}, o = e.parents(i.originalElement[0]).length ? ["width", "height"] : ["width", "height", "top", "left"];
    ...
    function() {
        ...
        _tabKeydown: function(e) {
            ...
            if (!this._handlePageNav(e)) {
                ...
                e.preventDefault(), clearTimeout(this.activating), s = this._focusNextTab(s, n), e.ctrlKey || e.metaKey || (i.attr("aria-selected", "false"),
                    this.tabs.eq(s).attr("aria-selected", "true"), this.activating = this._delay(function() {
