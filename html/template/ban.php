<html lang="en"><head>
		...
		<title>Ban/Unban - CSEURO.COM</title>
...
<script>
	...
	<div class="container">
		<div class="navbar-header">
			...
			<a class="navbar-brand" style="padding-top:0px;padding-bottom:0px;padding-right:0px" href="./adminsupport"><img alt="CSEURO.COM" style="margin-top:8px;margin-bottom:8px;margin-right:5px" src="template/img/logopanel.png"></a>
		</div>
		<div id="navbar" class="navbar-collapse collapse">
        <div style="float:right;    padding-top: 10px;">
			<ul class="nav navbar-nav">
				<li class=""><a href="/adminsupport">Admin Ticket</a></li>
...
<footer class="container footer">
	<div class="">
		<div class="pull-left" style="overflow:hidden">
			<a href="http://steamcommunity.com/groups/CSGODually" target="_blank"><img src="template/img/logo_footer.png"></a>
		</div>
		<div class="pull-right" style="overflow:hidden;">
			<a href="http://steamcommunity.com/groups/CSGODually" target="_blank"><img src="template/img/code.png"></a>
