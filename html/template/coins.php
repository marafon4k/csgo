<html lang="en"><head>
		...
		<title>Coins player - CSEURO.COM</title>
	...
	<div class="container">
        ...
        <div style="float:right;    padding-top: 10px;">
			<ul class="nav navbar-nav">
				...
				<li class="active"><a href="/coins">Coins</a></li>
			</ul>
			<? if($user): ?>
...
<footer class="container footer">
	<div class="">
		<!--<div class="pull-left" style="overflow:hidden">
			<a href="http://steamcommunity.com/groups/" target="_blank"><img src="template/img/logo_footer.png"></a>
		</div>
		<div class="pull-right" style="overflow:hidden;">
			<a href="http://steamcommunity.com/groups/" target="_blank"><img src="template/img/code.png"></a>
